...
const nomeroMaximoDePersonagens = 671;
let points = 0;

let nomeDoPersonagem;

generateRandomNumber = () => {
    return Math.floor(Math.random() * nomeroMaximoDePersonagens);
}
...
handlePoints = (characterName, inputValue) => {
    if(characterName == inputValue){
        points = points + 1;
    }else{
        nomeDeErrp.innerHTML = `Errou nome era 
